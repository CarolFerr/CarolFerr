...
![Front-end](https://skillicons.dev/icons?i=html,css,javascript,vuejs,vuetify,py,fastapi,java,spring,flutter,dart,mongodb,mysql)
 
* **Outras:**

![Back-end](https://skillicons.dev/icons?i=figma,git,github)

# 🖥️⌨️🖱️ Ambientes de Desenvolvimento

![Ambientes](https://skillicons.dev/icons?i=vscode,pycharm,idea,androidstudio,PowerBi)
...
![Analysis](https://img.shields.io/badge/Analitics-PowerBi-white)
